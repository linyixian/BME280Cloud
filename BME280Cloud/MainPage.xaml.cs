...
namespace BME280Cloud
{
    ...
    {
        // IoT Hub 接続用
        private const string cnString = "<Device Explorer で生成した接続文字列>";
        ...
        /// </summary>
        /// <returns></returns>
        private async void SendDataToAzure(double Tmp, double Pre, double Hum)
        {
            var sendData = new
            {
                Temperature = Tmp,
